/*
	This main.cpp file was provided by Seneca College Computer Programming for testing purposes.
*/
...
int main(int argc, char** argv)
{
	...
	try {
		...
		//Select an object and verify all the functionality is working
		cout << "========================================" << endl;
